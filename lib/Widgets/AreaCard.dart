  ...
  Widget build(BuildContext context) {
    return Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xff272727),//Theme.of(context).colorScheme.onTertiary,
                       ...
                       const SizedBox(height: 10,) ,
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(snapshot.data?.docs[index]["name"],style: GoogleFonts.alice(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),overflow: TextOverflow.ellipsis,maxLines: 2),
