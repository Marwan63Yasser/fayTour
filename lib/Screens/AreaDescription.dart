...
//the explore page 
import 'package:faytour/Data/CheckFavorite.dart';
import 'package:faytour/Widgets/hotels.dart';
import 'package:faytour/Screens/Trip.dart';
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: ((context, snapshot) {
        return Container(
          ...
          style: GoogleFonts.acme(fontSize: 22,color: Theme.of(context).colorScheme.secondary,fontWeight: FontWeight.bold),),margin: const EdgeInsets.symmetric(horizontal: 20,vertical: 5),)
      ),
        Align(
          alignment: Alignment.center,
        ...
        margin: const EdgeInsets.all(10),)
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextButton(
                                    ...
                                    child: Text("Go to it!",style: GoogleFonts.rye(color: Theme.of(context).colorScheme.onSecondary,fontSize: 18),),
